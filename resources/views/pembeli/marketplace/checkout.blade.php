...
<div class="relative min-h-screen pb-20">
    ...
    <div class="mb-12 animate-in fade-in slide-in-from-left duration-700">
        <h1 class="text-4xl md:text-5xl font-black text-[#1b1b18] tracking-tight mb-2">Selesaikan <span class="text-[#F53003]">Pesanan</span></h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="space-y-4">
                            ...
                            <label class="block relative cursor-pointer group">
                                ...
                                <div class="p-8 bg-gray-50 border border-gray-100 rounded-[2rem] peer-checked:border-[#F53003] peer-checked:bg-orange-50/50 transition-all group-hover:border-gray-200 shadow-sm relative overflow-hidden">
                                    <div class="flex justify-between items-start mb-4">
                                        <div class="flex items-center gap-3">
                                            <span class="w-8 h-8 rounded-full bg-white flex items-center justify-center border border-gray-100 text-gray-400 peer-checked:text-[#F53003] transition-colors">
                                ...
                                <div class="absolute top-8 right-8 hidden peer-checked:block text-[#F53003]">
                ...
                <div class="bg-white rounded-[3.5rem] p-10 border border-gray-100 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] relative overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <label class="relative cursor-pointer group">
                            ...
                            <div class="p-6 bg-gray-50 border border-gray-100 rounded-[2rem] peer-checked:border-[#F53003] peer-checked:bg-[#F53003] peer-checked:text-white transition-all text-center h-full flex flex-col justify-between group-hover:border-gray-300 shadow-sm">
                                <div>
                                ...
                                <div class="py-2 bg-white peer-checked:bg-white/20 rounded-xl">
                                    <p class="font-black text-[#F53003] peer-checked:text-white">Rp25.000</p>
                                </div>
                            </div>
                        </label>
                        <label class="relative cursor-pointer group">
                            ...
                            <div class="p-6 bg-gray-50 border border-gray-100 rounded-[2rem] peer-checked:border-[#F53003] peer-checked:bg-[#F53003] peer-checked:text-white transition-all text-center h-full flex flex-col justify-between group-hover:border-gray-300 shadow-sm">
                                ...
                                <div class="py-2 bg-white peer-checked:bg-white/20 rounded-xl">
                                    <p class="font-black text-[#F53003] peer-checked:text-white">Rp15.000</p>
                                </div>
                            </div>
                        </label>
                        <label class="relative cursor-pointer group">
                            ...
                            <div class="p-6 bg-gray-50 border border-gray-100 rounded-[2rem] peer-checked:border-[#F53003] peer-checked:bg-[#F53003] peer-checked:text-white transition-all text-center h-full flex flex-col justify-between group-hover:border-gray-300 shadow-sm">
                                ...
                                <div class="py-2 bg-white peer-checked:bg-white/20 rounded-xl">
                                    <p class="font-black text-[#F53003] peer-checked:text-white">Rp10.000</p>
                                </div>
                            </div>
                        </label>
                    </div>
                ...
                <div class="bg-white rounded-[3.5rem] p-10 border border-gray-100 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] relative overflow-hidden">
                    ...
                    <div class="space-y-4">
                        <label class="flex items-center p-6 bg-gray-50 border border-gray-100 rounded-[2rem] cursor-pointer hover:bg-gray-100 transition-colors group">
                            <input type="radio" name="metode_pembayaran" value="transfer" class="w-5 h-5 text-[#F53003] focus:ring-[#F53003] border-gray-300" checked>
                        ...
                        <label class="flex items-center p-6 bg-gray-50 border border-gray-100 rounded-[2rem] cursor-pointer hover:bg-gray-100 transition-colors group">
                            <input type="radio" name="metode_pembayaran" value="ewallet" class="w-5 h-5 text-[#F53003] focus:ring-[#F53003] border-gray-300">
                            <div class="ml-6 flex-1">
            ...
            <div class="lg:col-span-4 space-y-8 animate-in fade-in slide-in-from-right duration-1000">
                <div class="bg-[#1b1b18] rounded-[3.5rem] p-10 shadow-2xl relative overflow-hidden sticky top-24 text-white">
                    <div class="absolute -right-20 -top-20 w-64 h-64 bg-[#F53003] rounded-full blur-3xl opacity-20"></div>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="space-y-4 mb-8 pt-6 border-t border-white/10">
                            ...
                            @if($diskon > 0)
                            <div class="flex justify-between items-center text-[#F53003] bg-[#F53003]/10 p-3 rounded-xl border border-[#F53003]/20">
                        ...
                        <button type="submit" class="w-full py-6 bg-[#F53003] text-white rounded-[2rem] font-black text-xs tracking-[0.2em] uppercase shadow-2xl shadow-orange-900/40 hover:bg-[#FF4433] transition-all transform hover:scale-[1.02] active:scale-[0.98] flex justify-center items-center gap-3">
                            BUAT PESANAN
