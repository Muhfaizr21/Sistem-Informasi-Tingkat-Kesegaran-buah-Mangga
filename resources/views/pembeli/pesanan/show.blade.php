        ...
        <div class="lg:col-span-8 space-y-10 animate-in fade-in slide-in-from-left duration-1000">
            ...
            <div class="bg-white rounded-[3.5rem] p-10 lg:p-14 border border-gray-100 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] relative overflow-hidden group">
                ...
                <div class="relative z-10 space-y-10">
                    @php
                        $steps = [
                            'menunggu_bayar' => ['label' => 'Menunggu Pembayaran', 'desc' => 'Menunggu konfirmasi pembayaran Anda.', 'icon' => 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z'],
                            'dikonfirmasi' => ['label' => 'Dikonfirmasi', 'desc' => 'Pembayaran berhasil dikonfirmasi.', 'icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
        ...
        <div class="lg:col-span-4 space-y-8 animate-in fade-in slide-in-from-right duration-1000">
            <div class="sticky top-24 space-y-8">
                ...
                <form action="{{ route('pembeli.pesanan.selesai', $pesanan->id) }}" method="POST">
                    @csrf
                    <button type="submit" class="w-full py-5 bg-emerald-500 text-white rounded-[2rem] font-black text-xs tracking-[0.2em] uppercase shadow-2xl shadow-emerald-900/30 hover:bg-emerald-600 transition-all transform hover:scale-[1.02] active:scale-[0.98]">
