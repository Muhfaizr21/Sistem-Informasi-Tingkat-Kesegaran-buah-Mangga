    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] antialiased">
        <div class="min-h-screen flex flex-col items-center justify-center p-6 text-center">
            <div class="max-w-md w-full">
                <div class="mb-8 flex justify-center text-red-500">
                    <div class="relative">
                        <x-application-logo class="h-24 w-auto grayscale opacity-30" />
                        <div class="absolute inset-0 flex items-center justify-center">
                            <span class="text-6xl font-black text-[#1b1b18] dark:text-[#EDEDEC] tracking-tighter">403</span>
                        </div>
                    </div>
                </div>
                
                <h1 class="text-3xl font-bold mb-4 dark:text-[#EDEDEC]">Maaf, Kebun Ini Dipagari.</h1>
                <p class="text-gray-500 dark:text-[#A1A09A] mb-10">
                    Anda tidak memiliki izin untuk mengakses area ini. Silakan hubungi admin jika ini adalah kesalahan.
                </p>
