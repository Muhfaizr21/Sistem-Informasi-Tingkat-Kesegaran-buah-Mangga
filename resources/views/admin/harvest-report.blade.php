<x-admin-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-surface-container-lowest border border-outline-variant p-5 rounded-2xl">
            ...
            <p class="text-2xl font-bold text-on-surface">{{ $reports->sum('weight') }} <span class="text-xs font-normal">Kg</span></p>
        </div>
        <div class="bg-surface-container-lowest border border-outline-variant p-5 rounded-2xl">
        ...
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-outline-variant">
                ...
                <tr class="hover:bg-surface-container-low transition-colors">
                    ...
                    <td class="px-6 py-4 text-sm font-medium text-on-surface">{{ $report->variety }}</td>
                    <td class="px-6 py-4 text-sm font-bold text-center">{{ $report->weight }}</td>
